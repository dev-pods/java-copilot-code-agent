...
public class Activity {
    ...
    public Activity(String name, String description, String schedule, 
                   ScheduleDetails scheduleDetails, int maxParticipants) {
    ...
    public ScheduleDetails getScheduleDetails() { return scheduleDetails; }
    public void setScheduleDetails(ScheduleDetails scheduleDetails) { this.scheduleDetails = scheduleDetails; }
    
    public int getMaxParticipants() { return maxParticipants; }
    public void setMaxParticipants(int maxParticipants) { this.maxParticipants = validateMaxParticipants(maxParticipants); }
